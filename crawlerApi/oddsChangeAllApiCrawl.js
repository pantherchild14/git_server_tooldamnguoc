...
function generateUrl(domain, key, BET_ID) {
    const url = '__DOMAIN__/sport/football/odds/all/changes?api_key=__KEY_API__&companyId=__BET_ID__';
...
// Hàm lấy lịch trình
const crawlOddsChangeAllApi = async () => {
