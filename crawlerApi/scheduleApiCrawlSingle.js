...
function generateUrl(domain, key, matchid) {
    const url = '__DOMAIN__/sport/football/schedule?api_key=__KEY_API__&matchId=__MATCH_ID__';
...
// Hàm lấy lịch trình
const crawlScheduleSingleApi = async (matchID) => {
