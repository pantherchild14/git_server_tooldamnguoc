...
function generateUrl(domain, key, date) {
    const url = '__DOMAIN__/sport/football/schedule?api_key=__KEY_API__&date=__DATE__';
...
// Hàm lấy lịch trình
const crawlScheduleApi = async (DATE) => {
    const DOMAIN = process.env.DOMAIN_API;
    const KEY = process.env.KEY_API;
    const replacedUrl = generateUrl(DOMAIN, KEY, DATE);
